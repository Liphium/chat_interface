...
A new Flutter FFI plugin project.
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_LDFLAGS' => '-force_load ${BUILT_PRODUCTS_DIR}/librust_lib.a -lc++ -framework AudioToolbox -framework IOKit -framework CoreAudio -framework OpenAL -framework Foundation',
  }
end
