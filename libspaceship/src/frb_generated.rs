...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 209884421;
...
fn wire__crate__api__audio_devices__create_lightwire_engine_impl(
                ...
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok(
                            crate::api::audio_devices::create_lightwire_engine().await,
                        )?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn wire__crate__api__audio_devices__set_voice_enabled_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_engine =
                <crate::api::audio_devices::LightwireEngine>::sse_decode(&mut deserializer);
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::audio_devices::set_voice_enabled(api_engine, api_enabled)
                                .await;
                        })?;
                        Ok(output_ok)
                    })()
...
fn wire__crate__api__audio_devices__start_packet_engine_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "start_packet_engine",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::audio_devices::start_packet_engine(
                                api_engine,
                                api_packet_sink,
                            )
                            .await;
...
impl SseDecode for crate::api::audio_devices::LightwireEngine {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_id = <u32>::sse_decode(deserializer);
        return crate::api::audio_devices::LightwireEngine { id: var_id };
    }
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__audio_devices__create_lightwire_engine_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        6 => wire__crate__api__audio_devices__set_voice_enabled_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__audio_devices__start_packet_engine_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        2 => wire__crate__api__audio_devices__get_default_input_device_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__audio_devices__get_input_devices_impl(ptr, rust_vec_len, data_len),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::audio_devices::LightwireEngine {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [self.id.into_into_dart().into_dart()].into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::audio_devices::LightwireEngine
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::audio_devices::LightwireEngine>
    for crate::api::audio_devices::LightwireEngine
{
    fn into_into_dart(self) -> crate::api::audio_devices::LightwireEngine {
        self
    }
}
...
impl SseEncode for crate::api::audio_devices::LightwireEngine {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
