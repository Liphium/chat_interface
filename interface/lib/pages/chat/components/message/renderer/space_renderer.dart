      ...
      child: Obx(() {
        ...
        if (!_info.value!.exists) {
          ...
          return Container(
              ...
              child: Text("This space does not exist",
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Visibility(
                                ...
                                child: Flexible(
                                  child: SizedBox(
                                    ...
                                    child: Stack(
                                      children:
                                          List.generate(renderAmount, (index) {
                                        return Positioned(
                                          left: index * 25,
                                          child: Tooltip(
                              ...
                              Visibility(
                                visible: partyAmount >= renderAmount &&
                                    renderAmount > 0 &&
                                    partyAmount != renderAmount,
                                child: Padding(
                                  padding: const EdgeInsets.only(
                                      left: defaultSpacing),
                                  child: Text("+${partyAmount - renderAmount}",
                                      style: Get.theme.textTheme.bodyLarge),
                                ),
                              ),
                              Visibility(
                                visible: renderAmount == 0,
                                child: Text("$partyAmount members",
                                    style: Get.theme.textTheme.bodyLarge),
                              )
                            ],
                          )
