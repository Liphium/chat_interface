                              ...
                              children: [
                                ...
                                Obx(() => ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        final session = gameController
                                            .sessions.values
                                            .elementAt(index);
                                        final game =
                                            gameController.games[session.game]!;

                                        return Padding(
                                            padding: const EdgeInsets.only(
                                                top: sectionSpacing),
                                            child: Obx(() {
                                              final selected = gameController
                                                      .engine
                                                      .value
                                                      ?.sessionId ==
                                                  session.id;
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final game = gameController.games.values
                                        .elementAt(index);
                ...
                if (gameController.engine.value != null) {
                  return Column(
                    children: [
                      Expanded(
                          child: Obx(() =>
                              gameController.engine.value!.render(context))),
