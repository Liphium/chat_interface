    ...
    return Obx(() => Row(
      ...
      children: [
        ...
        Switch(
          ...
          trackColor: MaterialStateColor.resolveWith((states) => states.contains(MaterialState.selected) ? Get.theme.colorScheme.primary : Get.theme.colorScheme.onBackground),
