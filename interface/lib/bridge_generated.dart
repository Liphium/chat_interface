...
class SpaceLibImpl implements SpaceLib {
  final SpaceLibPlatform _platform;
  factory SpaceLibImpl(ExternalLibrary dylib) =>
      SpaceLibImpl.raw(SpaceLibPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory SpaceLibImpl.wasm(FutureOr<WasmModule> module) =>
      SpaceLibImpl(module as ExternalLibrary);
  SpaceLibImpl.raw(this._platform);
  Stream<LogEntry> createLogStream({dynamic hint}) {
...
class SpaceLibPlatform extends FlutterRustBridgeBase<SpaceLibWire> {
  SpaceLibPlatform(ffi.DynamicLibrary dylib) : super(SpaceLibWire(dylib));
...
class SpaceLibWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  SpaceLibWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  SpaceLibWire.fromLookup(
