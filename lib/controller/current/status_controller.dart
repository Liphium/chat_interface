...
class StatusController {
  ...
  static String statusJson() => jsonEncode(<String, dynamic>{"s": base64Encode(utf8.encode(status.peek())), "t": type.peek()});

  /// Create a new status json.
  static String newStatusJson(String status, int type) => jsonEncode(<String, dynamic>{"s": base64Encode(utf8.encode(status)), "t": type});
