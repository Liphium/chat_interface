...
class TownSettingTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'en_US': {
      ...
      'settings.town.own_town.desc':
          'Connected to @domain on version @version (protocol version: @protocol)',
      'settings.town.address': 'Your address',
      'settings.town.address.desc':
          'This address can be used to add you as a friend by people outside of your town.',
      'settings.town.address.copied':
          'Your address has been copied. Anyone can use it add you as a friend.',
      ...
      'tabletop.general.color.description':
          'This will be the color everyone sees when you are selecting something or moving your cursor.',
      ...
      'settings.file.uploaded.description':
          'You are currently using @current out of your available @max.',
      'settings.file.uploaded.none':
          'No uploaded files. Try to send messages or create a deck to upload files.',
      'settings.file.mb': 'MB',
    },
  };
}
