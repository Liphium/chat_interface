...
class TopicAddWindow extends StatefulWidget {
  final Square square;

  const TopicAddWindow({super.key, required this.square});

  @override
  State<TopicAddWindow> createState() => _TopicAddWindowState();
}

class _TopicAddWindowState extends State<TopicAddWindow> {
  // Text controllers
  ...
  Widget build(BuildContext context) {
    return DialogBase(
      title: [Text("squares.topics.create".tr, style: Get.textTheme.labelLarge)],
      child: Column(
        ...
        children: [
          ...
          FJElevatedLoadingButtonCustom(
            loading: _loading,
            onTap: () => save(),
            child: Center(child: Text("create".tr, style: Get.theme.textTheme.labelLarge)),
          ),
        ],
      ),
    );
