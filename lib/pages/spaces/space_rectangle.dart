...
class _SpaceRectangleState extends State<SpaceRectangle> {
  ...
  // Space tabs
  final _tabs = [const SpaceInfoTab(), const TabletopView()];

  // Sidebar tabs
  final _sidebarTabs = [const SpacesMessageFeed(), const SpaceMembersTab()];
                  ...
                  child: Stack(
                    children: [
                      ...
                      Align(
                        ...
                        child: Watch(
                          (context) => Animate(
                            effects: [FadeEffect(duration: 150.ms, end: 0.0, begin: 1.0)],
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [Colors.black.withAlpha(0), Colors.black.withAlpha(70)],
                                ),
                              ),
