...
List<Widget> renderEntites(
    double bottom, double right, BoxConstraints constraints,
    [int maxHero = 17, List<String>? toRender]) {
...
List<Widget> renderCircleEntites(double bottom, double right,
